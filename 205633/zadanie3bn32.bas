...
Const Fcrystal =(8000000 /(2 ^ Prescfc))                    'czêstotliwoœæ po przeskalowaniu
...
Do
   sbic ucsra,rxc                                           'obejœcie gdy nie obebrano znaku
      rcall rs_rx
...
!rs_tx:
   sbis ucsra,udre                                          'obejœcie gdy UDR0 zajêty
      ret
