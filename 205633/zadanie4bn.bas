...
Const _fpr = 10     'czêstotliwoœc próbkowania
...
!rs_rx:
   ...
   sbi adcsra,adsc  'zainicjowanie konwersji

   lds rstemp,{aw}  'offset zapisu
   'inc rstemp
   subi rstemp,(256-2)       'dodanie 2
...
!rs_tx:
   ...
   ld rstemp,y+     'zaladowanie LSB
   sts {znak},rstemp       'bajt do przetworzenia i wysylki
   ld rstemp,y      'zaladowanie MSB
   sts {znak+1},rstemp       'bajt do przetworzenia i wysylki
