...
Data 150 , 22 , 19 , 100 , 255 , 20 , 20 , 20 , 24 , 6 , 6 , 6 , 6 , 6 , 6 , 6       'ile bajtow odbieramy od urzadzenia = (bof +ilosc danych+eof)+12 aby byc pewnym ze sie zmiesci . Min okolo 6
...
For Pomocnicza = 1 To 16
    Readeeprom Adres(pomocnicza) , Pomocnicza
    Readeeprom Czas(pomocnicza) , Pomocnicza
...
!CLI
    Stanodbioru = 0
   Adro = Adres(nrodbiornika + 1)                           'odczyt adresu odbiornika z listy eeprom
 ...
 Ocr0a = Czas(nrodbiornika) * _ocrtimer0                    'ocr0a=ilosc bajtow*czas trwania transmisji 1 bajta



 lds rstemp,{adro}                                          'tworzenie ramki bof
 ori rstemp,192                                             'dodanie do adresu ramki bof
